...
public final class EntityFactory
{
  ...
  public static long makeYellowAlien(EntitySystem es, int x, int y, double moveDelay)
  {
    ...
    es.putComponent(id, new TimedMove(0, 1, true, moveDelay));
  ...
  public static long makeGreenAlien(EntitySystem es, int x, int y, double moveDelay)
  {
    long id = es.newEntity();
  ...
  public static long makeCyanAlien(EntitySystem es, int x, int y, double moveDelay)
  {
    long id = es.newEntity();
  ...
  public static long makeRedAlien(EntitySystem es, int x, int y, double moveDelay)
  {
    long id = es.newEntity();
